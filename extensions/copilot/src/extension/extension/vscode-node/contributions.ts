...
export const vscodeNodeContributions: IExtensionContributionFactory[] = [
	...
	// BYOK exposes user-supplied API key providers (Ollama, Anthropic, Gemini, OpenAI, ...)
	// and must be available without a Copilot login, so it lives in the always-on list.
