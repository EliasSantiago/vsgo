...
export function registerAllProviders(storage: ByokStorage, local: LocalProvider, vsgo: VsgoProvider): vscode.Disposable {
	...
	subs.push(vscode.lm.registerLanguageModelChatProvider('vsgo', vsgo));
