...
export interface IAuthenticationProviderHostDelegate {
	...
	/**
	 * @param errorOnUserInteraction Reject instead of prompting the user when the
	 * registration cannot be completed automatically. Callers starting something in
	 * the background pass this so a server that needs a hand does not interrupt.
	 */
	create(authorizationServer: URI, serverMetadata: IAuthorizationServerMetadata, resource: IAuthorizationProtectedResourceMetadata | undefined, clientId?: string, errorOnUserInteraction?: boolean): Promise<string>;
}
...
export interface IAuthenticationService {
	 ...
	 */
	createDynamicAuthenticationProvider(authorizationServer: URI, serverMetadata: IAuthorizationServerMetadata, resourceMetadata: IAuthorizationProtectedResourceMetadata | undefined, clientId?: string, errorOnUserInteraction?: boolean): Promise<IAuthenticationProvider | undefined>;
}
