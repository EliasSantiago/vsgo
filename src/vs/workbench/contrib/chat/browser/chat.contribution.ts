...
import { registerChatSkillActions } from './actions/chatSkillActions.js';
...
import { ChatProviderStatusContribution } from './chatProviderStatusEntry.js';
import { ChatBYOKWelcomeContribution } from './chatBYOKWelcomeContribution.js';
...
registerWorkbenchContribution2(ChatProviderStatusContribution.ID, ChatProviderStatusContribution, WorkbenchPhase.BlockRestore);
registerWorkbenchContribution2(ChatBYOKWelcomeContribution.ID, ChatBYOKWelcomeContribution, WorkbenchPhase.BlockStartup);
