...
export class SetupAgent extends Disposable implements IChatAgentImplementation {
	...
	private static readonly SETUP_NEEDED_MESSAGE = new MarkdownString(localize('settingUpProviderNeeded', "Configure um provedor de modelo de linguagem ou baixe um modelo compatível com o hardware do seu computador."));
